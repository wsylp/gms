...
public interface UserMapper extends BaseMapper<User> {
    ...
    List<User> getUserList(@Param("filter") UserSearchFilter filter, @Param("pagination") Pagination pagination);
    ...
    int countUserList(@Param("filter") UserSearchFilter filter);
}